...
from glhf.helper import asyncio_eventify, asyncio_queueify, patch
...
class Bot(BotProtocol):
    ...
    def game_start(self, data: GameStartDict) -> GameStartDict:
        asyncio.create_task(self.queue_update.put(None))
        return data
    ...
    def game_over(self) -> None:
        asyncio.create_task(self.game_update.put(None))
    ...
    async def run(self) -> None:
        ...
        queue_id = secrets.token_urlsafe(3)
